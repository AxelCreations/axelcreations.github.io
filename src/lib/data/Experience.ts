...
export const ExperienceData: ExperienceModel[] = [
  ...
  },
  {
    ...
    excerpt: 'Assist request and incidents of the Oracle PeopleSoft platform users and create solutions using the PeopleCode programming...',
    initialDate: 'December 2021',
